...
DB_NAME="example_db"
username="adminuser" # Change to a suitable username (See README.md)
password="Password123" # Change to a suitable password (See README.md)
...
# Insert sample data
sudo mysql -e "USE ${DB_NAME}; INSERT INTO employees (name, position, salary) VALUES ('Steve', 'Engineer', 75000), ('Bill', 'Manager', 85000);"
